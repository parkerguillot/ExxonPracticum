...
urls = 'https://www.ewg.org/news/news-releases'
...
# response.xpath('//div[(@class="field field-name-field-twitter-id field-type-text field-label-hidden")]/a/@href]')
        article_date = response.xpath('//span[@class = "date-display-single"]//text()').extract()
        article_title = response.xpath('//h1[@class = "title"]//text()').extract()
        author = response.xpath('//div[@class = "field-item even"]/a//text()').extract()
